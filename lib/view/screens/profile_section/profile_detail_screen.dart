          ...
          child: SingleChildScrollView(
            child: Column(mainAxisAlignment: MainAxisAlignment.start,
                ...
                children: [
                  ...
                  Text("Name",style: TextStyle(color: Colors.black,fontSize: 12.px,fontWeight: FontWeight.w500),),

                  SizedBox(height: 0.5.h,),
                  Text("Mohsin ali raza",style: TextStyle(color: Colors.black,fontSize: 14.px,fontWeight: FontWeight.w400),),
                  Divider(color: Colors.grey.withOpacity(0.2),),
                  SizedBox(height: 1.h,),
                  Text("Service Category",style: TextStyle(color: Colors.black,fontSize: 12.px,fontWeight: FontWeight.w500),),
                  SizedBox(height: 0.5.h,),
                  Text("Carpenter",style: CustomTextStyle.textForgotOrange),
                  Divider(color: Colors.grey.withOpacity(0.2),),
                  SizedBox(height: 1.h,),
                  Text("Business details",style: TextStyle(color: Colors.black,fontSize: 12.px,fontWeight: FontWeight.w500),),
                  SizedBox(height: 0.5.h,),
                  Text("""Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.""",style: TextStyle(color: Colors.black,fontSize: 14.px,fontWeight: FontWeight.w400),),
                  Divider(color: Colors.grey.withOpacity(0.2),),
                  SizedBox(height: 1.h,),
                  Text("Phone Number",style: TextStyle(color: Colors.black,fontSize: 12.px,fontWeight: FontWeight.w500),),
                  SizedBox(height: 0.5.h,),
                  Text("92 3204626050",style: TextStyle(color: Colors.black,fontSize: 14.px,fontWeight: FontWeight.w400),),
                  Divider(color: Colors.grey.withOpacity(0.2),),
                  SizedBox(height: 1.h,),
                  Text("Address",style: TextStyle(color: Colors.black,fontSize: 12.px,fontWeight: FontWeight.w500),),
                  SizedBox(height: 0.5.h,),
                  Text("Lahore, Punjab",style: TextStyle(color: Colors.black,fontSize: 14.px,fontWeight: FontWeight.w400),),
                  Divider(color: Colors.grey.withOpacity(0.2),),
                  SizedBox(height: 1.h,),
                  Text("Post code",style: TextStyle(color: Colors.black,fontSize: 12.px,fontWeight: FontWeight.w500),),
                  SizedBox(height: 0.5.h,),
