...
import '../my_task_section/my_task_table_broken_home.dart';
import '../my_task_section/task_pro_home_screen.dart';
import '../profile_section/profile_home_screen.dart';
          ...
          body: Obx(() {
            switch (currentIndex.value) {
              ...
              // return the corresponding Favorites screen
                return  const TaskProHomeScreen(); // Replace with actual screen
              case 2:
